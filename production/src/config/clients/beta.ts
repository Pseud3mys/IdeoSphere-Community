...
Quels bénéfices concrets pour notre commune et ses habitants ?`,
  ...
  groupTypes: {
    ...
    types: [
      {
        id: 'commission',
        label: 'Commission thématique',
        labelPlural: 'Commissions thématiques',
        description: 'Un groupe de travail pour développer une partie du programme',
        icon: '📋',
      },
      {
        id: 'project',
        label: 'Action collective',
        labelPlural: 'Actions collectives',
        description: 'Un groupe pour organiser une action ou un événement',
        icon: '🎯',
      },
      {
        id: 'local',
        ...
        description: 'Un groupe lié à un quartier ou une zone géographique',
        icon: '📍',
      },
      {
        id: 'working-group',
  ...
  integrations: {
    ...
    kumu: {
      ...
      embedUrl: 'https://embed.kumu.io/24fc024151324e9b98b75dc36df8f22f',
      
      // URL directe vers le projet Kumu
      projectUrl: 'https://embed.kumu.io/4b1560a7d6213293340bf979098d9db3#beta-export',
